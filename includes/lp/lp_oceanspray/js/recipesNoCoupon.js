...
function toggleItem(el, id, intId) {
    ...
    switch (intId) {
        case 1:
            ...
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Frozen_Blueberry_Yogurt_Pops');};
            break;
        case 2:
            recipeCardLink.href = "/pdfs/Blueberry/OceanSpray_Blueberry Bran Muffins.pdf";
            recipeCard.alt = "Blueberry Bran Muffins";
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Blueberry_Bran_Muffins');};
            break;
        case 3:
            recipeCardLink.href = "/pdfs/Blueberry/OceanSpray_Blueberry Smoothies.pdf";
            recipeCard.alt = "Blueberry Smoothies";
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Blueberry_Smoothies');};
           	break;
       // case 4:
       ...
       //     break;
        case 5:
            ...
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Pork_Chops_with_Blueberry_Craisin_Sauce');};
            break;
        case 6:
            ...
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon//Print_Recipe/Blueberry_Lemon_Cheesecake_Bars');};
            break;
        case 7:
            recipeCardLink.href = "/pdfs/Blueberry/OceanSpray_Blueberry Cosmo.pdf";
            recipeCard.alt = "Blueberry Cosmo";
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Blueberry_Cosmo');};
            break;
        case 8:
        ...
        default:
            recipeCardLink.href = "/pdfs/Blueberry/OceanSpray_Blueberry Mint Lemonade.pdf";
           	recipeCard.alt = "Blueberry-Mint Lemonade";
            recipeCardLink.onclick = function(){pageTracker._trackPageview('/OceanSpray_com/Event/News/Blueberry_Non_Coupon/Print_Recipe/Blueberry-Mint_Lemonade');};
        }
}
